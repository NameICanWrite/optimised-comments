		...
		isLoading
			?
				<div style={{width: '100%'}}>
					...
					<p style={{textAlign: 'center', width: '100vw'}} className={styles.waitMessage}>{waitTime >= 3 ? `Please wait for demo server to wake up. It can take up to 5 min. Waiting time: ${waitTime} s` : ""}</p>
					<br />
